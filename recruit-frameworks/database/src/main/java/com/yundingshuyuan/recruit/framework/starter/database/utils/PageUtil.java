package com.yundingshuyuan.recruit.framework.starter.database.utils;

import com.baomidou.mybatisplus.core.metadata.IPage;
import com.baomidou.mybatisplus.extension.plugins.pagination.Page;
import com.yundingshuyuan.framework.starter.convention.page.PageRequest;
import com.yundingshuyuan.framework.starter.convention.page.PageResponse;
...
public class PageUtil {
    ...
    public static <TARGET, ORIGINAL> PageResponse<TARGET> convert(IPage<ORIGINAL> iPage, Class<TARGET> targetClass) {
        iPage.convert(each -> MapstructUtils.convert(each, targetClass));
        return buildConventionPage(iPage);
    }
